...
if ( ! function_exists( 'colormag_footer_copyright' ) ) :
	...
	function colormag_footer_copyright() {
		...
		$wp_link = '<a href="http://www.glapttech.com" target="_blank" title="' . esc_attr__( 'GlaptTech', 'colormag' ) . '" rel="nofollow"><span>' . esc_html__( 'GlaptTech', 'colormag' ) . '</span></a>';
